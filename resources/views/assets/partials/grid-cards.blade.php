    @php
        // The index-context query params, built by AssetController::buildIndexData() from the
        // CONTEXT_KEYS allowlist, so the show page can reconstruct the result set (cycle
