...
@section('content')
<div class="max-w-7xl mx-auto sm:px-6 lg:px-8" x-data="tikzPng()" data-testid="tool-tikz-png">
    ...
    <div class="bg-white rounded-lg shadow p-6 mb-6 flex flex-col gap-4">
        <h2 class="text-base font-semibold text-gray-900">
            ...
            {{ __('TikZ Input') }}
            <span class="inline-flex items-center ml-2 px-2 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-500">{{ __('Deprecated') }}</span>
        </h2>
