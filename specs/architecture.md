...
- `php artisan config:clear && php artisan test` — the full Pest suite (1127 tests,
  90 files: `tests/Feature/` incl. `Auth/`,`Console/`,`Middleware/`; `tests/Unit/`
...
- `npm run test:e2e` — the Playwright browser suite (131 tests across 21 spec files)
