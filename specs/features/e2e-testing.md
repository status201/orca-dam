...
125 tests across 21 spec files (120 literal `test()` calls plus 5 generated by the
`tools.spec.js` loop), on top of the 4 in `global.setup.js` — so
`npx playwright test --list` reports **129 tests in 22 files**. Counting only literal
